...
type SpecItem = SpecTreeItem | PhaseTreeItem;

export class SpecsProvider implements vscode.TreeDataProvider<SpecItem> {
  private _onDidChangeTreeData: vscode.EventEmitter<
    SpecItem | undefined | null | void
  > = new vscode.EventEmitter<SpecItem | undefined | null | void>();
  ...
  getChildren(element?: SpecItem): Thenable<SpecItem[]> {
    ...
    if (
      ...
      element.contextValue?.startsWith("specWith")
    ) {
  ...
  private getPhaseItems(spec: Spec): PhaseTreeItem[] {
